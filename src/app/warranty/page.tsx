...
//         {/* Warranty Plans */}
//         <section id="warranty-plans" className="mb-8">
//           <div className="text-center mb-8 sm:mb-12">
//             <h2 className="text-2xl sm:text-3xl md:text-4xl font-heading font-bold text-ink mb-4 tracking-tight">
//               Warranty Plans
//             </h2>
...
//               <div 
//                 key={index} 
//                 className={`group relative bg-surface rounded-xl border shadow-xs p-4 sm:p-6 hover:shadow-md transition-all duration-300 overflow-visible ${
//                   plan.popular ? 'border-gray-300 ring-2 ring-gray-200 mt-4' : 'border-border hover:border-neutral-300 mt-6 sm:mt-8'
//                 }`}
//               >
...
//                     <span className="bg-gray-900 text-white px-3 sm:px-4 py-1 sm:py-1.5 rounded-full text-xs font-medium shadow-sm">
//                       Most Popular
//                     </span>
//                   </div>
//                 )}
...
//                   <h3 className="text-base sm:text-lg font-heading font-semibold text-ink mb-2">
//                     {plan.name}
//                   </h3>
//                   <div className="text-xl sm:text-2xl font-bold text-ink mb-1">{plan.price}</div>
//                   <div className="text-xs sm:text-sm text-body/80">{plan.duration}</div>
...
//                         <span className="text-xs sm:text-sm text-body/80">{feature}</span>
//                       </li>
//                     ))}
//                   </ul>
...
//           <div className="bg-surface rounded-xl sm:rounded-2xl border border-border shadow-xs p-4 sm:p-8">
//             <div className="text-center mb-6 sm:mb-8">
//               <h2 className="text-xl sm:text-2xl md:text-3xl font-heading font-bold text-ink mb-4">
//                 How Our Warranty Works
//               </h2>
//               <p className="text-sm sm:text-base text-body/80">
...
//                   <span className="text-base sm:text-lg font-bold text-ink">1</span>
//                 </div>
...
//               <div className="text-center">
//                 <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-3">
//                   <span className="text-base sm:text-lg font-bold text-ink">2</span>
//                 </div>
...
//               <div className="text-center">
//                 <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-3">
//                   <span className="text-base sm:text-lg font-bold text-ink">3</span>
//                 </div>
...
//               <div className="text-center">
//                 <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-3">
//                   <span className="text-base sm:text-lg font-bold text-ink">4</span>
//                 </div>
...
//               <div 
//                 key={index} 
//                 className="group relative bg-surface rounded-xl border border-border shadow-xs p-4 sm:p-6 hover:shadow-md hover:border-neutral-300 transition-all duration-300 overflow-hidden"
//               >
...
//                 <div className="relative">
//                   <h3 className="text-base sm:text-lg font-heading font-semibold text-ink mb-2 group-hover:text-brand transition-colors">
//                     {pkg.name}
//                   </h3>
//                   <p className="text-xs sm:text-sm text-body/80 mb-4">{pkg.description}</p>
//                   <ul className="space-y-2">
//                     {pkg.services.map((service, serviceIndex) => (
//                       <li key={serviceIndex} className="flex items-center text-xs sm:text-sm text-body/80">
