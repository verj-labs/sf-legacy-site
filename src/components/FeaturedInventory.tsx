    ...
    <section id="inventory" className="section-padding bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-h2 font-heading font-bold text-ink mb-6">
            Featured Vehicles
          </h2>
          <p className="text-body-l text-body leading-relaxed max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
            {featuredVehicles.length === 0 ? (
              <div className="col-span-full text-center py-12">
                <p className="text-body text-body/60 mb-4">No featured vehicles available at the moment.</p>
