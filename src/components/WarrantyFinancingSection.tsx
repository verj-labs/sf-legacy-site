        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14">
          ...
          <div className="group relative bg-surface rounded-2xl p-8 md:p-10 border border-border shadow-xs hover:shadow-md hover:border-neutral-300 transition-all duration-300 overflow-hidden">
            ...
            <div className="relative">
              ...
              <p className="text-body text-body/80 leading-relaxed mb-6 max-w-prose">
                We offer a full range of <strong>Warranty Plans</strong> from essential coverage to
                comprehensive Exclusionary protection. Get guidance on the option that fits how you
                drive.
              </p>
              <ul className="space-y-2.5 mb-8">
                {warrantyFeatures.map((item) => (
                  <li key={item} className="flex items-start gap-3">
                    <span className="mt-1 inline-flex items-center justify-center w-5 h-5 rounded-full bg-ink text-white text-[10px] ring-1 ring-neutral-300">
              ...
              <Link
                href="/warranty"
                className="btn-primary inline-flex items-center gap-2 px-6 py-3 rounded-lg group/button text-ink hover:text-primary-50"
              >
                <span className="font-medium tracking-tight">Learn About Warranty</span>
                <HiClipboardDocumentList className="w-5 h-5  first-letter:transition-colors" />
              </Link>
            </div>
          ...
          <div className="group relative bg-surface rounded-2xl p-8 md:p-10 border border-border shadow-xs hover:shadow-md hover:border-neutral-300 transition-all duration-300 overflow-hidden">
            ...
            <div className="relative">
              ...
              <p className="text-body text-body/80 leading-relaxed mb-6 max-w-prose">
                We secure the best <strong>financing plan</strong> for your needs by working across
                multiple lending partners, making purchasing straightforward and transparent.
              </p>
              <ul className="space-y-2.5 mb-8">
              ...
              >
                ...
                <HiCurrencyDollar className="w-5 h-5 transition-colors" />
              </Link>
            </div>
            <span className="pointer-events-none absolute inset-x-0 bottom-0 h-px bg-gradient-to-r from-transparent via-neutral-200 to-transparent" />
          </div>
