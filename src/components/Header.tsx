...
export default function Header() {
  ...
  return (
    <header
      className={`sticky top-0 z-50 bg-white border-b border-border shadow-sm transition-all duration-med flex justify-between items-center px-16 ${
      ...
      <div className="flex-shrink-0">
        <Link href="/" className="flex items-center">
          <Image
            ...
            className="transition-all duration-med"
          />
        </Link>
      </div>
            ...
            {navigation.map((item) => {
              ...
              return (
                <Link
                  key={item.name}
                  href={item.href}
                  className={`block px-3 py-2 font-medium text-body-m transition-colors duration-fast ${
                    isActive 
